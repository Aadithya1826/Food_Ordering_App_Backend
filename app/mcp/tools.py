...
def build_customer_tool_prompt(
    ...
    lines = [
        ...
        "  - If flow_stage is COLLECT_PHONE: interpret input as their phone number (e.g., '9840810585', 'My mobile number is 9840810585'). Extract the 10 digits and emit set_customer. If the user instead corrects their name (e.g. 'No, my name is Gayathri'), emit set_customer with the new name, keep the stage as COLLECT_PHONE, and politely ask for the phone number again.",
